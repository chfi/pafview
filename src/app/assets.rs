...
fn load_icons(mut commands: Commands, asset_server: Res<AssetServer>) {
    let xmark = asset_server.load("icons/xmark-circle.png");
    let xmark_solid = asset_server.load("icons/xmark-circle-solid.png");
    let paste_clipboard = asset_server.load("icons/paste-clipboard.png");
    let clipboard_check = asset_server.load("icons/clipboard-check.png");
